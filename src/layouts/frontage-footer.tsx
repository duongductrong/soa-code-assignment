    ...
    <footer {...props}>
      <section
        className={cn(
          ...
          "min-h-[666px] flex justify-center pt-17"
        )}
      >
        <div className="flex flex-col gap-6">
          <p className="text-white font-sans text-6xl font-semibold leading-[60px] capitalize max-w-[647px] text-center">
            <span className="text-brand inline-block">Explorez avec BASIC</span>
            <span className="text-brand/50 inline-block">dès aujourd’hui</span>
          </p>
          <p className="max-w-[647px] text-center font-sans text-2xl font-normal text-[#562C2C]">
